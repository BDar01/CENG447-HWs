...
vec3 I = vec3(intensity*0.3, intensity*0.3, intensity*0.3);
vec3 Iamb = vec3(0.8, 0.8, 0.8);

vec3 kd = vec3(0.7, 0.7, 0); // Changed blue component to 0, and increased green
vec3 ka = vec3(0.1, 0.1, 0); // Changed blue component to 0, and increased green
vec3 ks = vec3(0.8, 0.8, 0); // Changed blue component to 0, and increased green
