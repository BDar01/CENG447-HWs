...
vec3 kd = vec3(1.0, 0.0, 0.0); // High red, no green, no blue
vec3 ka = vec3(0.1, 0.0, 0.0); // Adjust ambient color to have red only
vec3 ks = vec3(0.8, 0.0, 0.0); // Adjust specular color to have red only
